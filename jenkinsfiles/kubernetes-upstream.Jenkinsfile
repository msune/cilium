            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:51e7b8d3ab272db4be5e674ef5b4620b2391e92a@sha256:ae512d754b515cee3dc1570fe5432bdd473b5f702abde204d84723d0a681bae5"
                    }
                }
            }
        }
