					  ...
					  __u64 len)
{
	...
	switch (len) {
	case 256:          __it_xor(x, y, r, 64); fallthrough;
	case 248: jmp_248: __it_xor(x, y, r, 64); fallthrough;
	case 240: jmp_240: __it_xor(x, y, r, 64); fallthrough;
	case 232: jmp_232: __it_xor(x, y, r, 64); fallthrough;
	case 224: jmp_224: __it_xor(x, y, r, 64); fallthrough;
	case 216: jmp_216: __it_xor(x, y, r, 64); fallthrough;
	case 208: jmp_208: __it_xor(x, y, r, 64); fallthrough;
	case 200: jmp_200: __it_xor(x, y, r, 64); fallthrough;
	case 192: jmp_192: __it_xor(x, y, r, 64); fallthrough;
	case 184: jmp_184: __it_xor(x, y, r, 64); fallthrough;
	case 176: jmp_176: __it_xor(x, y, r, 64); fallthrough;
	case 168: jmp_168: __it_xor(x, y, r, 64); fallthrough;
	case 160: jmp_160: __it_xor(x, y, r, 64); fallthrough;
	case 152: jmp_152: __it_xor(x, y, r, 64); fallthrough;
	case 144: jmp_144: __it_xor(x, y, r, 64); fallthrough;
	case 136: jmp_136: __it_xor(x, y, r, 64); fallthrough;
	case 128: jmp_128: __it_xor(x, y, r, 64); fallthrough;
